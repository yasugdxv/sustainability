...
const STRINGS: Record<Lang, Record<string, string>> = {
  ja: {
    ...
    "competitor.targets.subtitle": "サントリーが目標を掲げている領域について、競合各社の対応する目標と比較できます。",
    "competitor.targets.empty": "該当する目標はまだありません。",
    "competitor.targets.company": "企業",
    "competitor.targets.theme": "テーマ",
    "competitor.targets.goalCategory": "目標カテゴリ",
    "competitor.targets.ownTargets": "サントリーの目標",
    "competitor.targets.competitorTargets": "競合各社の目標",
    "competitor.targets.noCompetitorTarget": "対応する競合目標はまだありません",
    ...
    "competitor.companies.ownBadge": "自社",
    ...
    "competitor.filter.allGoalCategories": "すべての目標カテゴリ",
    ...
    "search.period": "期間",
    "search.period.7": "1週間",
    "search.period.30": "1ヶ月",
    "search.period.90": "3ヶ月",
    "search.period.all": "全期間",
    "search.subtags": "詳細タグ",
    "search.subtags.showMore": "もっと見る",
    "search.subtags.showLess": "閉じる",
    ...
    // Phase B: Department Intelligence AI — 他部門Intelligenceの出典表示（Chat/Search共通）
    "provenance.department.geopolitics": "地政学",
    "provenance.department.sustainability": "サステナビリティ",
    "provenance.reuseType.exact_cache": "既存分析を再利用",
    "provenance.reuseType.retrieved": "既存分析を再利用",
    "provenance.requestQuestion": "問い合わせ内容",
    "provenance.assessmentTitle": "タイトル",
    "provenance.asOf": "時点",
    "provenance.references": "参照情報",
    "search.relatedIntelligence": "Related Intelligence",
    "search.whyRelevant": "関連理由",
    ...
    "article.importanceTotalValue": "合計 {total} / 35点",
    "article.importanceBreakdown": "評価内訳",
    "article.importanceBreakdownHint": "AIが7つの観点それぞれを0〜5点で採点し、合計点でランクを決定しています。",
    "article.allTags": "テーマ・タグ",
  ...
  en: {
    ...
    "competitor.targets.subtitle": "Compare Suntory's stated targets against competitors' targets in the same areas.",
    "competitor.targets.empty": "No targets found.",
    "competitor.targets.company": "Company",
    "competitor.targets.theme": "Theme",
    "competitor.targets.goalCategory": "Goal Category",
    "competitor.targets.ownTargets": "Suntory's Targets",
    "competitor.targets.competitorTargets": "Competitors' Targets",
    "competitor.targets.noCompetitorTarget": "No matching competitor target yet",
    ...
    "competitor.companies.ownBadge": "Own Company",
    ...
    "competitor.filter.allGoalCategories": "All Goal Categories",
    ...
    "search.period.7": "1 week",
    "search.period.30": "1 month",
    "search.period.90": "3 months",
    "search.period.all": "All time",
    "search.subtags": "Detailed tags",
    "search.subtags.showMore": "Show more",
    "search.subtags.showLess": "Show less",
    ...
    // Phase B: Department Intelligence AI — cross-domain intelligence provenance (Chat/Search)
    "provenance.department.geopolitics": "Geopolitics",
    "provenance.department.sustainability": "Sustainability",
    "provenance.reuseType.exact_cache": "Reused from prior analysis",
    "provenance.reuseType.retrieved": "Reused from prior analysis",
    "provenance.requestQuestion": "Question asked",
    "provenance.assessmentTitle": "Title",
    "provenance.asOf": "As of",
    "provenance.references": "References",
    "search.relatedIntelligence": "Related Intelligence",
    "search.whyRelevant": "Why relevant",
    ...
    "article.importanceTotalValue": "Total {total} / 35 pts",
    "article.importanceBreakdown": "Score breakdown",
    "article.importanceBreakdownHint": "The AI scores 7 criteria from 0-5 each; the total determines the rank.",
    "article.allTags": "Themes & tags",
